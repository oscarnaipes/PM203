    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <Text style={styles.cardText}>Duracion: 30 minutos</Text>
